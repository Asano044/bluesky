  ...
  <div class="container-fluid mx-0 px-1 ">
    ...
    <nav class="navbar  navbar-expand-sm">
      <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
          <a class="nav-link" href="./formulario.php">RELATÓRIO VOO</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link active" href="./cad_solicitacoes.php"> BALANÇO</a>
        </li>
          ...
          <div class="form_container">
            ...
            <div class="w3-row w3-border insert_bx">
              ...
              <div class="w3-container w3-third select_bx">
                <label for="dt-variavel">Data:</label>
                <div class="input_field"> <span class="box1"><i class='bx bx-notepad'></i></span>
                  <input type="date" name="data_financ" id="data_financ" />
                </div>
              </div>

              <div class="w3-container w3-third select_bx">
                <label for="descricao">Descrição</label>
                <div class="input_field"> <span class="box1"><i class='bx bx-edit'></i></span>
                  <input type="text" name="descricao" id="descricao" />
                </div>
              </div>

              <div class="w3-container w3-third select_bx">
                <label for="vl-desp">Valor</label>
                <div class="input_field"> <span class="box1"><i class='bx bx-wallet'></i></span>
                  <input type="text" name="valor_financ" id="valor_financ" />
                </div>
              </div>
            </div>
